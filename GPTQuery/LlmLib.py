...
class Chat:
    def __init__(self, requestJSON : bool, model : str = "gpt-5-mini_2025-08-07"):
        self.query = {
                "model": model,
                "messages": [],
...
class Llm:
    ...
    def __init__(self, batch_size: int = 10):
        self.api_endpoint = "https://legoresearch.econlabs.org/llm/run"
        self.api_endpointbackground = "https://legoresearch.econlabs.org/llm/runbackground"
