...
#     with open(os.path.join("evaluations", dataFolder, key + "_closed.json"), "r") as file:
...
#             for j, segment in enumerate(article.return_classified_segments()):
...
html=html.replace("REVIEWER","Test Reviewer")
